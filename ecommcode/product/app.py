...
app = Flask(__name__)
@app.route('/product/v1/status', methods=['GET'])
def status():
    successmessage={"status": 200}
    return(successmessage)
@app.route('/product/v1/dumpproduct', methods=['GET'])
def dumpproduct():
...
@app.route('/product/v1/getallproduct', methods=['GET'])
def getallproduct():
  awsregion=os.environ['AWS_REGION']
  TableName=os.environ['TABLE_NAME']
  dynamodb=boto3.resource('dynamodb',region_name=awsregion)
...
@app.route('/product/v1/getproductbyid', methods=['POST'])
def getproductsbyid():
  awsregion=os.environ['AWS_REGION']
  TableName=os.environ['TABLE_NAME']
  dynamodb=boto3.resource('dynamodb',region_name=awsregion)
